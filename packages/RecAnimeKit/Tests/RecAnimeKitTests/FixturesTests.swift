...
struct FixturesTests {
    ...
    func fixturesLoad() throws {
        for name in ["me", "anime_detail", "anime_franchise", "anime_episodes", "seasons_index", "season_now", "top",
                     "search", "recommendations", "library_grouped", "library_item", "schedule", "error_not_found", "error_validation"] {
